...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    policyRoutingOpenRouterSystemPromptDesc: "This is the system prompt sent to the LLM via OpenRouter within the \"getCaFRoutingRecommendation\" tool, where the AI adopts the LLaMA 4 Scout persona.",
    policyRoutingOpenRouterUserPromptLabel: "OpenRouter Tool: User Prompt (LLaMA 4 Scout Persona)",
    policyRoutingOpenRouterUserPromptDesc: "This is an example of the user prompt structure sent to the LLM via OpenRouter. The actual triage text is dynamically inserted.",
  ...
  fr: {
    ...
    policyRoutingOpenRouterSystemPromptDesc: "Ceci est l'invite système envoyée au LLM via OpenRouter au sein de l'outil \"getCaFRoutingRecommendation\", où l'IA adopte la personnalité LLaMA 4 Scout.",
    policyRoutingOpenRouterUserPromptLabel: "Outil OpenRouter : Invite Utilisateur (Personnalité LLaMA 4 Scout)",
    policyRoutingOpenRouterUserPromptDesc: "Ceci est un exemple de la structure d'invite utilisateur envoyée au LLM via OpenRouter. Le texte de triage réel est inséré dynamiquement.",
